...
LEFT_SHARPA_UR5_LINK_TO_ADJACENT_LINKS = {
    "base_link": ["shoulder_link"],
    "shoulder_link": ["base_link", "upper_arm_link"],
    "upper_arm_link": ["shoulder_link", "forearm_link"],
    "forearm_link": ["upper_arm_link", "wrist_1_link"],
    "wrist_1_link": ["forearm_link", "wrist_2_link"],
    "wrist_2_link": ["wrist_1_link", "wrist_3_link"],
    "wrist_3_link": [
        "wrist_2_link",
        "left_thumb_CMC_VL",
        "left_thumb_MC",
    ...
    "left_index_MCP_VL": ["wrist_3_link", "left_index_PP"],
    "left_index_PP": ["wrist_3_link", "left_index_MCP_VL", "left_index_MP"],
    "left_index_MP": ["left_index_PP", "left_index_DP"],
    "left_index_DP": ["left_index_MP"],
    "left_middle_MCP_VL": ["wrist_3_link", "left_middle_PP"],
    "left_middle_PP": ["wrist_3_link", "left_middle_MCP_VL", "left_middle_MP"],
    "left_middle_MP": ["left_middle_PP", "left_middle_DP"],
    "left_middle_DP": ["left_middle_MP"],
    "left_pinky_MC": ["wrist_3_link", "left_pinky_MCP_VL", "left_pinky_PP"],
    "left_pinky_MCP_VL": ["left_pinky_MC", "left_pinky_PP"],
    "left_pinky_PP": ["left_pinky_MC", "left_pinky_MCP_VL", "left_pinky_MP"],
    "left_pinky_MP": ["left_pinky_PP", "left_pinky_DP"],
    "left_pinky_DP": ["left_pinky_MP"],
    "left_ring_MCP_VL": ["wrist_3_link", "left_ring_PP"],
    "left_ring_PP": ["wrist_3_link", "left_ring_MCP_VL", "left_ring_MP"],
    "left_ring_MP": ["left_ring_PP", "left_ring_DP"],
    "left_ring_DP": ["left_ring_MP"],
    "left_thumb_CMC_VL": ["wrist_3_link", "left_thumb_MC"],
    "left_thumb_MC": [
        "wrist_3_link",
        "left_thumb_CMC_VL",
        "left_thumb_MCP_VL",
